...
public class MainActivity_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(MainActivity_2.this,MainActivity2_2.class);
    ...
    class Readdate extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter = new Customadapter(MainActivity_2.this, android.R.layout.simple_list_item_1, mangdocbao);
