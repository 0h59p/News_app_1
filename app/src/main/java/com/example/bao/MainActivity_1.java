...
public class MainActivity_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new Readdate().execute("https://cdn.24h.com.vn/upload/rss/anninhhinhsu.rss");
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(MainActivity_1.this,MainActivity1_1.class);
    ...
    class Readdate extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            customadapter = new Customadapter(MainActivity_1.this, android.R.layout.simple_list_item_1, mangdocbao);
